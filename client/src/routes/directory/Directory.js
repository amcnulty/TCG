...
function Directory(props) {
    ...
    return (
        <div className='Directory'>
            <div className="landingSection py-3">
            ...
            <div className='mapSection py-5'>
                <div className="container">
                    <p>Interact with the map below and click on map markers to see more information about a specific location.</p>
                    <MapContainer
                        center={center}
                        zoom={zoom}
